...
\textbf{จำนวนหน่วยกิต:} ไม่ระบุในเอกสารโครงสร้างรายวิชา\\
\textbf{ระดับผู้เรียน:} นักศึกษาระดับปริญญาตรี สาขาวิชาเทคโนโลยีวิศวกรรมไฟฟ้า\\
\textbf{สัปดาห์ตามแผนการจัดการเรียนรู้:} สัปดาห์ที่ 13\\
\textbf{จำนวนชั่วโมงที่แนะนำ:} 3 ชั่วโมงบรรยายและฝึกวิเคราะห์โจทย์ (ข้อเสนอเพื่อให้สอดคล้องกับแผน 1 สัปดาห์)\\
\textbf{ความยาวเป้าหมาย:} 25–30 หน้า A4\\
\textbf{รูปแบบการเรียน:} บรรยายร่วมกับตัวอย่างคำนวณ การวิเคราะห์วงจร และกิจกรรมอภิปราย\\
...
\subsubsection{7.3 การแปลงวงจรจากโดเมนเวลาไปสู่โดเมน $s$}
...
\begin{itemize}
    \item $R=20\,\Omega<R_{\text{crit}}$ → \textbf{underdamped}
    \item $R=100\,\Omega=R_{\text{crit}}$ → \textbf{critically damped}
    \item $R=200\,\Omega>R_{\text{crit}}$ → \textbf{overdamped}
\end{itemize}
...
\begin{itemize}
    \item $\sigma>0$ → ซองลดลง
    \item $\omega_d$ → ความถี่การสั่น
\end{itemize}
...
\subsubsection{กิจกรรมที่ 1: จากวงจรจริงสู่สมการและโดเมน $s$}
...
\begin{itemize}
    \item $R=10\,\Omega<63.25\,\Omega$ → underdamped
    \item $R=63.25\,\Omega$ → critically damped
    \item $R=100\,\Omega>63.25\,\Omega$ → overdamped
\end{itemize}
