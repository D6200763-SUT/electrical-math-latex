...
\begin{table}[htbp]
    ...
    \begin{tabular}{l l l l l}
        ...
        \hline
        CLO6.1 อธิบายความหมายและความสำคัญของลาปลาซ & 6.1–6.2, การลู่เข้า, โดเมน $s$ & วิเคราะห์แผนภาพ time domain → $s$-domain และอภิปรายความหมาย & คำถามปากเปล่า/แบบทดสอบสั้น & คำตอบอธิบายด้วยภาษาของตนเอง \\
...
\subsubsection{7.1.1 จากโดเมนเวลาไปสู่โดเมน $s$}
...
\subsubsection{7.1.3 ข้อสังเกตเรื่องลาปลาซด้านเดียวและค่า ณ $t=0$}
...
\subsubsection{7.2.3 ตัวอย่างจากนิยาม: $f(t)=1$}
...
\subsubsection{7.2.4 ตัวอย่างจากนิยาม: $f(t)=e^{-3t}$}
...
\begin{itemize}
    \item พหุนามเวลา $t^n$ ↔ กำลังของ $1/s$
    \item เอกซ์โพเนนเชียล $e^{at}$ ↔ ตัวประกอบ $1/(s-a)$
    \item ไซน์และโคไซน์ ↔ พหุนามกำลังสอง $s^2+\omega^2$
    \item การหน่วงเวลา ↔ ตัวคูณ $e^{-as}$
\end{itemize}
...
\subsubsection{7.4.2 การเลื่อนในโดเมน $s$ (First Shifting Theorem)}
...
\subsubsection{7.4.5 ลาปลาซของอนุพันธ์อันดับ $n$}
...
\subsubsection{7.4.7 การคูณด้วย $t$}
...
\begin{itemize}
    \item $t<1$: ทั้งสอง step เป็นศูนย์ → $f=0$
    \item $1\le t<4$: step แรกเป็น 1 → $f=3$
    \item $t\ge4$: ทั้งสองเป็น 1 → $f=3-2=1$
\end{itemize}
...
\subsubsection{กิจกรรมสั้นที่ 1: จับคู่ Time Domain กับ $s$-Domain}
...
\subsubsection{8.1 คิดว่า $s$ คือความถี่ $\omega$ โดยตรง}
...
\subsubsection{8.3 ใช้ Time Shift แต่ไม่เปลี่ยนตัวแปรภายในเป็น $t-a$}
...
\subsubsection{8.6 คิดว่า $\delta(t)$ เป็นพัลส์ที่มี “ค่าอนันต์” แบบตัวเลขธรรมดา}
...
\subsubsection{8.8 ได้ $Y(s)$ แล้วหยุด}
...
\begin{enumerate}
    ...
    \item วิธีแก้ ODE ด้วยลาปลาซคือ แปลง → ใส่ initial conditions → แก้ $Y(s)$ → จัดรูป → inverse → ตรวจคำตอบ
...
\begin{itemize}
    \item 20 นาที: Motivation จาก ODE ในงานไฟฟ้าและแนวคิด time domain → $s$-domain
